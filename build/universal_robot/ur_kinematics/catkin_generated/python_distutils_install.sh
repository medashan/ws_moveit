...
echo_and_run cd "/home/medashan/ws_moveit/src/universal_robot/ur_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/medashan/ws_moveit/src/universal_robot/ur_kinematics/setup.py" \
     \
    build --build-base "/home/medashan/ws_moveit/build/universal_robot/ur_kinematics" \
    install \
    --root="${DESTDIR-/}" \
